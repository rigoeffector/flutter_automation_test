...
class User extends Equatable{
  ...
  final String? firstName,lastName,addressline_1, gender, addressline_2, dob,memberNumber,email,msisdn, profile, country, city,weight, points,  height, bmi;
  const User({
    this.id,
    this.firstName,
    this.lastName,
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        memberNumber: (json['member_number'] != null) ? json['member_number']:"",
        email: json['email'],
  ...
  @override
  List<Object?> get props => [id, company != null, firstName,lastName,addressline_1, gender, addressline_2, dob,memberNumber,email,msisdn, profile, country, city,weight, points,  height, bmi];
}